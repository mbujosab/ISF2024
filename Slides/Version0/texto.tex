...
\begin{slide}
  ...
  \citet{Hodrick:nwu-cmsems-451, Hodrick:JMCB-29-1, whittaker1922new}
  \vspace{\stretch{1}}
  ...
  \begin{center}
    \fbox{Why $\lambda=1600$?}
  \end{center}
\end{slide}

\begin{slide}
  \heading{Why You Should Never Use the Hodrick-Prescott Filter \citep{Hamilton:RES-100-831}}
  \begin{center}
    \resizebox{\fijaAnchura{.98}{1.09}}{!}{\includegraphics{Figura 2_hamilton.png}}
  \end{center}  
\end{slide}
...
\begin{slide}
  \heading{Why You Should Never Use the Hodrick-Prescott Filter  \citep{Hamilton:RES-100-831}}
  \begin{center}
    \resizebox{\fijaAnchura{.98}{1.09}}{!}{\includegraphics{Figura 3_hamilton.png}}
  \end{center}  
\end{slide}
...
\begin{slide}
  ...
  \citep{Garcia-Ferrer:Environmetrics2013,Garcia-Ferrer:ISF2008}
\end{slide}
...
\begin{slide}
  ...
  \begin{center}
    ...
    \resizebox{\fijaAnchura{.98}{.9}}{!}{\includegraphics{./figuras/difftrendSRW.pdf}}\\
    %{\footnotesize First difference of IRW trend}\\
    \resizebox{\fijaAnchura{.98}{.9}}{!}{\includegraphics{./figuras/difftrendIRW.pdf}}
  \end{center}
  \begin{center}
    {\color{blue}Persuade or inform?}
  \end{center}
\end{slide}
...
\begin{slide}
  \heading{Modelling of Global Climate Change \citep{Young_2021}}
  \begin{center}
...
\begin{slide}
  \heading{Coronavirus trajectories}
  \begin{center}
    \resizebox{\fijaAnchura{.9}{.9}}{!}{\includegraphics{./figuras/coronavirus_world.jpg}} 
  \end{center}
\end{slide}
